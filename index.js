...
return response.send({ error: false, data: results, message: 'useful_part list.' });
});
});
...
if (!useful_part_id) {
return response.status(400).send({ error: true, message: 'Please provide useful_part_id' });
}
